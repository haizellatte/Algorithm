...
// console.log(toBinary(14)); // 1110

function fillZero(s, w) {
...
// console.log(fillZero('123', 4)); // 0123
// console.log(fillZero('3', 4)); // 0003

function replace(s, c, target) {
    let result = '';
...
function solution(n, arr1, arr2) {
    ...
    for (let i = 0; i < arr1.length; i++) {
        let temp = fillZero(toBinary(arr1[i] | arr2[i]), n);
        temp = replace(temp, '#', '1');
        temp = replace(temp, ' ', '0');
        answer.push(temp);
    }
...
console.log((9|30).toString(2)); // 11111
//  1001
// 11110
// 11111
...
console.log((20|1).toString(2)); // 10101
